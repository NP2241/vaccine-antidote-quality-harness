...
from beq.evals.constants import (
    DEFAULT_BOS_TOKEN,
    DEFAULT_EOS_TOKEN,
    DEFAULT_PAD_TOKEN,
    DEFAULT_UNK_TOKEN,
...
def resize_tokenizer_embedding(
    ...
    """Resize tokenizer and embedding (from PKU-Alignment utilities)."""
...
def calculate_binary_classification_metrics(
    ...
    assert labels.shape == predictions.shape, "The shapes of labels and predictions should be the same."
